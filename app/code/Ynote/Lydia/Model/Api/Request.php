<?php
namespace Ynote\Lydia\Model\Api;

use Ynote\Lydia\Model\Api\SIPS2\Utils;
...
class Request
{
    ...
    /**
     * Request constructor.
     * @param \Ynote\Lydia\Model\Api\SIPS2\Utils $utils
     * @param \Psr\Log\LoggerInterface $logger
     * @param \Ynote\Lydia\Model\Config $config
     */
    public function __construct(
        \Ynote\Lydia\Model\Api\SIPS2\Utils $utils,
    ...
    public function doRequest($parameters, $binPath, $sipsVersion = 1)
    {
        ...
        if($sipsVersion != 1){
            ...
            $secretKey = $this->_config->getconfigdata("secret_key", "lydia_standard");
            $sealAlgorithm = $this->_config->getconfigdata("seal_algorithm", "lydia_standard");
            $parameters['seal'] = $this->utils->computePaymentInitSeal(
                $sealAlgorithm,
                $parameters,
                $secretKey
            );
            $parameters["keyVersion"] = $this->_config->getConfigData("secret_key_version", "lydia_standard");
            ...
            $paysageJsonUrl = $this->_config->getConfigData("paysage_json_url", "lydia_standard");
