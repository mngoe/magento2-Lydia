...
abstract class AbstractMeans extends Adapter
{
     ...
     * @return string
     */
    abstract public function _getNormalReturnUrl();
     ...
     * @return string
     */
    abstract public function _getCancelReturnUrl();
    ...
    {
        //return Mage::getBaseDir('base') . DS . Mage::getStoreConfig('lydiaapi/config_bin_files/request_path');
        return $this->moduleDirReader->getModuleDir('', 'Ynote_Lydia') . 'view/res/' . $this->_code . '/bin/static/request';
    }
