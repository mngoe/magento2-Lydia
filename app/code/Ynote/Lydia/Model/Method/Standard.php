...
namespace Ynote\Lydia\Model\Method;
...
class Standard extends \Ynote\Lydia\Model\Method\AbstractMeans
{
    protected $_code = 'lydia_standard';
    protected $_formBlockType = 'Ynote\Lydia\Block\Form\Standard';
    protected $_infoBlockType = 'Ynote\Lydia\Block\Info\Standard';
    protected $_redirectBlockType = 'Ynote\Lydia\Block\Redirect\Standard';
    ...
    public function callRequest()
    {
        ...
        $sipsVersion = $this->getConfig()->getConfigData("sips_version", "lydia_standard");
        ...
        if ($sipsVersion == 1){
           ...
           // echo 'currency code'.print_r( $this->getConfig()->getCurrencyCode($this->_getQuote()->getQuoteCurrencyCode()), 1)."\n";
            $parameters = array(
                ...
                //"keyVersion" => $this->getConfig()->getConfigData("secret_key_version", "lydia_standard"),
                'merchantId' => $this->getConfig()->getMerchantId(),
                'normalReturnUrl' => $this->_getNormalReturnUrl(),
                'orderChannel' => "INTERNET",
                'orderId' => $this->_getOrderId(),
                //"secretKey" => $this->getConfig()->getConfigData("secret_key", "lydia_standard"),
...
//   "transactionReference" => "",  // usefull for native WL Sips 2.0 merchantIds.  Merchants migrating from WL Sips 1.0 will provide s10TransactionId instead
                //"sealAlgorithm" => $this->getConfig()->getConfigData("seal_algorithm", "lydia_standard"),
                //"paysage_json_url" => $this->getConfig()->getConfigData("paysage_json_url", "lydia_standard")
            );
    ...
    public function _getNormalReturnUrl()
    {
        ...
        return $this->urlInterface->getUrl('lydia/payment/normalcallback');
    }
    ...
    public function _getCancelReturnUrl()
    {
        ...
        return $this->urlInterface->getUrl('lydia/payment/cancel');
    }
    ...
    protected function _getAutomaticResponseUrl()
    {
        ...
        return $this->urlInterface->getUrl('lydia/payment/autoresponse');
    }
    ...
    public function getOrderPlaceRedirectUrl()
    {
        ...
        return $this->urlInterface->getUrl('lydia/payment/redirect');
    }
